run_gen_pop_v6=function(treat_cov_mild,treat_cov_severe,
  ...
  # fit with run_gen_pop_v6(0,0,0,1,0,73,1,7)
  library(deSolve)
  library(scales)
  library(cowplot)
  library(ggplot2)
...
solveGA_US_gen_pop_v2 = function(version_num){
  ...
  svals =c(0.02,rep(0.01,10))
  evals=c(0.1,0.3,rep(0.2,9))
  GA <- ga(type = "real-valued", fitness = asode_US_genpop_v2, lower = svals, upper = evals,monitor=TRUE,
